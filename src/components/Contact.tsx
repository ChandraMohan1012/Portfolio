...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      label: 'Location',
      value: 'Gibichettipalayam, Erode, Tamil Nadu, India',
      link: null,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-700 ${
            ...
            <div className="relative group">
              {/* Glow */}
              <div className="absolute -inset-4 bg-gradient-to-r from-white/20 via-gray-300/20 to-white/20 rounded-3xl blur-3xl opacity-0 group-hover:opacity-50 transition-all duration-700"></div>
          ...
          <div className="space-y-4">
            {contactInfo.map((info, index) => (
              ...
              >
                {/* Card glow */}
                <div className={`absolute -inset-1 bg-gradient-to-r ${info.gradient} rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition-all duration-500`}></div>
